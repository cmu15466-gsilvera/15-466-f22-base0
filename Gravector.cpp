...
#undef HEX_TO_U8VEC4
    ...
    // draw scores
    const float score_height = 0.5f;
    draw_rectangle(glm::vec2(-court_radius.x - wall_radius, court_radius.y + wall_radius + score_height),
                   glm::vec2(score[0], score_height), RED);
